...
const Progress4c = () => {
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        if (gestureState.dx < -50) {
          router.push('/(progress)/progress4d' as any);
  ...
  useEffect(() => {
    const fetchStep1 = async () => {
      try {
        ...
        const q = query(langkahRef, where('compare', '==', 'egg'));
  ...
  return (
    <ImageBackground
      source={require('@/assets/images/img_progress4.jpg')}
