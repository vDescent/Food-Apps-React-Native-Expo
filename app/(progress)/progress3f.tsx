...
const Progress3g = () => {
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        if (gestureState.dx < -50) {
          router.push('/(progress)/progress3g' as any);
  ...
  useEffect(() => {
    const fetchStep1 = async () => {
      try {
        ...
        const q = query(langkahRef, where('compare', '==', 'pancakes'));
  ...
  return (
    <ImageBackground
      source={require('@/assets/images/img_progress3.jpg')}
