...
const Progress6f = () => {
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        if (gestureState.dx < -50) {
          router.push('/(progress)/progress6g' as any);
  ...
  useEffect(() => {
    const fetchStep1 = async () => {
      try {
        ...
        const q = query(langkahRef, where('compare', '==', 'cap'));
  ...
  return (
    <ImageBackground
      source={require('@/assets/images/img_progress6.jpg')}
