  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        {/* Bagian Gambar */}
        <Image 
          source={require('@/assets/images/img_must2.png')} 
        ...
        {/* Bagian Tombol */}
        <Link href="/(progress)/progress5a" style={styles.button} asChild>
