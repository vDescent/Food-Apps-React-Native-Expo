  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        {/* Bagian Gambar */}
        <Image 
          source={require('@/assets/images/img_must1.png')} 
        ...
        {/* Bagian Tombol */}
        <Link href="/(progress)/progress4a" style={styles.button} asChild>
