  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        {/* Bagian Gambar */}
        <Image 
          source={require('@/assets/images/img_popular2.png')} 
        ...
        {/* Bagian Tombol */}
        <Link href="/(progress)/progress2a" style={styles.button} asChild>
